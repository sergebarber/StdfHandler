...
class RecordMirTest extends RecordTest {
    ...
    void testSetupT() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setSetupT(expected)),
    ...
    void testStartT() throws IOException {
        Instant expected = Instant.ofEpochSecond(1234567890);
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setStartT(expected)),
    ...
    void testStatNum() throws IOException {
        int expected = 123;
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setStatNum(expected)),
    ...
    void testModeCod() throws IOException {
        String expected = "A";
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setModeCod(expected)),
    ...
    void testRtstCod() throws IOException {
        String expected = "B";
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setRtstCod(expected)),
    ...
    void testProdCod() throws IOException {
        String expected = "C";
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setProtCod(expected)),
    ...
    void testBurnTim() throws IOException {
        int expected = 12345;
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setBurnTim(expected)),
    ...
    void testCmodCod() throws IOException {
        String expected = "D";
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setCmodCod(expected)),
    ...
    void testLotId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setLotId(expected)),
    ...
    void testPartTyp() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setPartTyp(expected)),
    ...
    void testNodeNam() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setNodeNam(expected)),
    ...
    void testTstrTyp() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setTstrTyp(expected)),
    ...
    void testJobNam() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setJobNam(expected)),
    ...
    void testJobRev() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setJobRev(expected)),
    ...
    void testSblotId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setSblotId(expected)),
    ...
    void testOperNam() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setOperNam(expected)),
    ...
    void testExecTyp() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setExecTyp(expected)),
    ...
    void testExecVer() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setExecVer(expected)),
    ...
    void testTestCod() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setTestCod(expected)),
    ...
    void testTstTemp() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setTstTemp(expected)),
    ...
    void testUserTxt() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setUserTxt(expected)),
    ...
    void testAuxFile() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setAuxFile(expected)),
    ...
    void testPkgTyp() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setPkgTyp(expected)),
    ...
    void testFamlyId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setFamlyId(expected)),
    ...
    void testDateCod() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setDateCod(expected)),
    ...
    void testFacilId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setFacilId(expected)),
    ...
    void testFloorId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setFloorId(expected)),
    ...
    void testProcId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setProcId(expected)),
    ...
    void testOperFrq() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setOperFrq(expected)),
    ...
    void testSpecNam() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setSpecNam(expected)),
    ...
    void testSpecVer() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setSpecVer(expected)),
    ...
    void testFlowId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setFlowId(expected)),
    ...
    void testSetupId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setSetupId(expected)),
    ...
    void testDsgnRev() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setDsgnRev(expected)),
    ...
    void testEngId() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setEngId(expected)),
    ...
    void testRomCod() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setRomCod(expected)),
    ...
    void testSerlNum() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setSerlNum(expected)),
    ...
    void testSuprNam() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordMir.newInstance().setSuprNam(expected)),
