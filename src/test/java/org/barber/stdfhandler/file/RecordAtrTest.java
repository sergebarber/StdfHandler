...
class RecordAtrTest extends RecordTest {
    ...
    void testAtrModTim() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordAtr.newIstance().setModTim(expected)),
    ...
    void testAtrCmdLine() throws IOException {
        ...
        testField(new FileBuilder().addRecord(RecordAtr.newIstance().setCmdLine(expected)),
