...
class RecordPmrTest extends RecordTest {
    ...
    void testPmrIndx() throws IOException {
        ...
        testOptionalField(new FileBuilder().addRecord(RecordPmr.newInstance().setPmrIndx(expected)),
    ...
    void testChanTyp() throws IOException {
        ...
        testOptionalField(new FileBuilder().addRecord(RecordPmr.newInstance().setChanTyp(expected)),
    ...
    void testChanNam() throws IOException {
        ...
        testOptionalField(new FileBuilder().addRecord(RecordPmr.newInstance().setChanNam(expected)),
    ...
    void testPhyNam() throws IOException {
        ...
        testOptionalField(new FileBuilder().addRecord(RecordPmr.newInstance().setPhyNam(expected)),
    ...
    void testLogNam() throws IOException {
        ...
        testOptionalField(new FileBuilder().addRecord(RecordPmr.newInstance().setLogNam(expected)),
    ...
    void testHeadNum() throws IOException {
        ...
        testOptionalField(new FileBuilder().addRecord(RecordPmr.newInstance().setHeadNum(expected)),
    ...
    void testsiteNum() throws IOException {
        ...
        testOptionalField(new FileBuilder().addRecord(RecordPmr.newInstance().setSiteNum(expected)),
