...
class RecordMirTest extends RecordTest {
    ...
    void testModeCod() throws IOException {
        String expected = "A";
        testOptionalField(fileHandler.getBuilder().addRecord(RecordMir.newInstance().setModeCod(expected)),
    ...
    void testRtstCod() throws IOException {
        String expected = "B";
        testOptionalField(fileHandler.getBuilder().addRecord(RecordMir.newInstance().setRtstCod(expected)),
    ...
    void testProdCod() throws IOException {
        String expected = "C";
        testOptionalField(fileHandler.getBuilder().addRecord(RecordMir.newInstance().setProtCod(expected)),
    ...
    void testCmodCod() throws IOException {
        String expected = "D";
        testOptionalField(fileHandler.getBuilder().addRecord(RecordMir.newInstance().setCmodCod(expected)),
