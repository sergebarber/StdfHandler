...
class RecordPcrTest extends RecordTest {
  ...
  void testHeadNum() throws IOException {
    ...
    testOptionalField(fileHandler.getBuilder().addRecord(RecordPcr.newInstance().setHeadNum(expected)),
  ...
  void testSiteNum() throws IOException {
    ...
    testOptionalField(fileHandler.getBuilder().addRecord(RecordPcr.newInstance().setSiteNum(expected)),
  ...
  void testPartCnt() throws IOException {
    ...
    testOptionalField(fileHandler.getBuilder().addRecord(RecordPcr.newInstance().setPartCnt(expected)),
  ...
  void testRtstCnt() throws IOException {
    ...
    testOptionalField(fileHandler.getBuilder().addRecord(RecordPcr.newInstance().setRtstCnt(expected)),
  ...
  void testAbrtCnt() throws IOException {
    ...
    testOptionalField(fileHandler.getBuilder().addRecord(RecordPcr.newInstance().setAbrtCnt(expected)),
  ...
  void testGoodCnt() throws IOException {
    ...
    testOptionalField(fileHandler.getBuilder().addRecord(RecordPcr.newInstance().setGoodCnt(expected)),
  ...
  void testFuncCnt() throws IOException {
    ...
    testOptionalField(fileHandler.getBuilder().addRecord(RecordPcr.newInstance().setFuncCnt(expected)),
